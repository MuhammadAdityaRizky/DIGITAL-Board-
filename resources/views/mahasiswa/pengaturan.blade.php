...
<body class="flex h-screen overflow-hidden text-slate-800 pb-16 lg:pb-0">
            ...
            <div class="bg-white border border-slate-200 shadow-sm rounded-xl p-6 max-w-xl">
                ...
                <div class="bg-rose-50 border border-rose-200 shadow-sm rounded-xl p-6">
                    ...
                    <p class="text-xs text-rose-700/80 mb-4">
                        Tekan tombol di bawah ini untuk mengakhiri sesi login Mahasiswa pada perangkat ini secara aman.
                    </p>
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
    ...
    <nav class="fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-slate-200 flex items-center justify-between px-3 z-40 lg:hidden shadow-lg">
        ...
        <a href="{{ route('mahasiswa.pengaturan') }}" class="flex flex-col justify-center items-center gap-1 flex-1 py-2 text-teal-800 font-bold">
