    ...
    <header class="h-16 bg-teal-900 text-white flex items-center justify-between px-6 lg:px-8 flex-shrink-0 shadow-md">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-[10px] font-semibold tracking-wider text-teal-300">MAHASISWA PORTAL</p>
            </div>
        </div>
        ...
        <div class="flex items-center gap-4">
            ...
            <form action="{{ route('logout') }}" method="POST" class="inline">
                @csrf
                <button type="submit" class="w-8 h-8 rounded-lg bg-teal-955/40 text-teal-200 hover:text-white flex items-center justify-center transition-all text-xs" title="Logout">
    ...
    <div class="flex-1 flex overflow-hidden">
        ...
        <aside class="w-64 bg-white border-r border-slate-200 flex flex-col flex-shrink-0 h-full hidden lg:flex">
            ...
            <nav class="flex-1 px-3 space-y-1">
                <a href="{{ route('mahasiswa.dashboard') }}" class="flex items-center gap-3 px-4 py-3 bg-teal-50 text-teal-900 rounded-xl w-full font-bold">
