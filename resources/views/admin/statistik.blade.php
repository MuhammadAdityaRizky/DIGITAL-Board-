...
<body class="flex h-screen overflow-hidden text-slate-800 pb-16 lg:pb-0">
    ...
    <aside class="w-64 bg-slate-900 text-white flex flex-col shrink-0 h-screen sticky top-0 hidden lg:flex">
        ...
        <nav class="flex-1 min-h-0 px-3 py-3 space-y-1 overflow-y-auto custom-sidebar-scroll">
            ...
            <a href="{{ route('admin.statistik') }}" class="flex items-center gap-3 px-4 py-2.5 bg-teal-850 text-white rounded-xl w-full font-bold">
                                    ...
                                    <label class="flex items-start gap-3 p-2 rounded-lg bg-white border border-slate-200 hover:border-teal-700 transition cursor-pointer text-xs">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            ...
                                            <span class="text-[10px] text-slate-500 font-semibold block mt-0.5">
                                                Program: {{ $ag->program_kuliah ?? 'Reguler' }} • Kelas: {{ $ag->kelas ?: '-' }} • Semester: {{ $ag->semester ?: '1' }}
                                            </span>
