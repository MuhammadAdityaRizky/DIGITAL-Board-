                                ...
                                @if(count($kelases) >= 2)
                                    ...
                                    @for($i = 0; $i < count($kNames); $i++)
                                        @for($j = $i + 1; $j < count($kNames); $j++)
                                            ...
                                            <div class="agenda-kelas-item px-2.5 py-2 text-xs text-slate-700 rounded-lg hover:bg-purple-50 hover:text-purple-950 cursor-pointer transition flex items-center justify-between gap-2 group"
                                                 data-name="{{ $comboVal }}"
