    ...
    <main class="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 lg:px-8 flex-shrink-0 shadow-xs">
            <div class="flex items-center gap-3">
                <a href="{{ route('dosen.agenda') }}" class="w-9 h-9 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 rounded-xl flex items-center justify-center transition cursor-pointer" title="Kembali ke Agenda">
                    <i class="fa-solid fa-arrow-left text-sm"></i>
                </a>
                <div>
                    <h2 class="font-extrabold text-base text-slate-800 md:hidden">Presensi Mahasiswa</h2>
                    <h2 class="font-extrabold text-lg text-slate-900 hidden md:block">Kelola Presensi Mahasiswa</h2>
                </div>
            </div>
